...
% Input: 
% A,B,C - the parameters of the system (22); 
% K     - the controller gain from (26); 
% L     - the observer gain from (23); 
...
% sigma - the event-triggering parameter from (21); 

% Output: 
% OmegaVal - the value of Omega from (21). If OmegaVal is empty, the LMIs are not feasible
